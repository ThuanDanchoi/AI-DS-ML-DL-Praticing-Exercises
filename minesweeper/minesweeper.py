...
class MinesweeperAI():
    ...
    def make_random_move(self):
        ...
        # Filter out moves already made and known mines
        valid_moves = [move for move in all_moves if move not in self.moves_made and move not in self.mines]

        # Return a random valid move if any exist
        if valid_moves:
